...
struct GameCatalogTests {
    ...
    @Test func everyBundledGameProfileIsTracked() {
        ...
        // of the real user Profiles directory, and a concurrent test writing a
        // `user-added-*.json` between them lands in the second and not the
        // first — so it arrives here looking like a shipped profile with no
        // catalog entry. Reproduced about 1 run in 4 on 12 Sep 2026.
