...
test('launched titles are the ones with Mac evidence, not theoretical ports', () => {
  ...
  assert.deepEqual(verified, ['ac-odyssey', 'ready-or-not', 'rv-there-yet', 'satisfactory', 'solarpunk', 'witcher-3', 'wolfenstein-youngblood']);
  assert.equal(data.counts.verified, 7);
});
